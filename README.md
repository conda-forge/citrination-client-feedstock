About citrination-client-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/citrination-client-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/CitrineInformatics/python-citrination-client

Documentation: http://citrineinformatics.github.io/python-citrination-client/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6592&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/citrination-client-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `citrination-client` can be installed with `conda`:
...
```
mamba install citrination-client
```

It is possible to list all of the versions of `citrination-client` available on your platform with `conda`:
...
```
mamba search citrination-client --channel conda-forge
```
...
mamba repoquery search citrination-client --channel conda-forge

# List packages depending on `citrination-client`:
mamba repoquery whoneeds citrination-client --channel conda-forge

# List dependencies of `citrination-client`:
mamba repoquery depends citrination-client --channel conda-forge
```
